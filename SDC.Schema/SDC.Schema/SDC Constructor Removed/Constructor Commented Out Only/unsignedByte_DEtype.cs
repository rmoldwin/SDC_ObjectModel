...
namespace SDC.Schema
{
	...
	public partial class unsignedByte_DEtype : unsignedByte_Stype
	{
		...
		protected internal bool _shouldSerializeminInclusive; //rm added 2022_09_22
		/// <summary>
		/// Test whether minInclusive should be serialized
		/// </summary>
		public virtual bool ShouldSerializeminInclusive() //rm added 2022_09_22
		{
			if (_shouldSerializeminInclusive)
			{
				return true;
			}
			return (_minInclusive > 0);
		}
		protected internal bool _shouldSerializemaxInclusive; //rm added 2022_09_22
		/// <summary>
		/// Test whether maxInclusive should be serialized
		/// </summary>
		public virtual bool ShouldSerializemaxInclusive() //rm added 2022_09_22
		{
			if (_shouldSerializemaxInclusive)
			{
				return true;
			}
			return (_maxInclusive > 0);
		}

		protected internal bool _shouldSerializeminExclusive; //rm added 2022_09_22
		/// <summary>
		/// Test whether minExclusive should be serialized
		/// </summary>
		public virtual bool ShouldSerializeminExclusive() //rm added 2022_09_22
		{
			if (_shouldSerializeminExclusive)
			{
				return true;
			}
			return (_minExclusive > 0);
		}

		protected internal bool _shouldSerializemaxExclusive; //rm added 2022_09_22
		/// <summary>
		/// Test whether maxExclusive should be serialized
		/// </summary>
		public virtual bool ShouldSerializemaxExclusive() //rm added 2022_09_22
		{
			if (_shouldSerializemaxExclusive)
			{
				return true;
			}
			return (_maxExclusive > 0);
		}
	}
}
