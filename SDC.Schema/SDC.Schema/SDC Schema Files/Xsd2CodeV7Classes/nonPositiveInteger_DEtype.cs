...
public partial class nonPositiveInteger_DEtype : nonPositiveInteger_Stype
{
    ...
    private bool _shouldSerializetotalDigits;
    ...
    private System.Nullable<sbyte> _totalDigits;
    ...
    /// </summary>
    public virtual bool ShouldSerializetotalDigits()
    {
        if (_shouldSerializetotalDigits)
        {
            return true;
        }
        return (_totalDigits != default(sbyte));
    }
