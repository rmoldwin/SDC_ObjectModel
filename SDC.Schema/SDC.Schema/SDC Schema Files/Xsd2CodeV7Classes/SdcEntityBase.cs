...

{
    ...
    private static ISerializer _serializerYaml;
    [XmlIgnore()]
    ...
    private static ISerializer SerializerYaml
    {
        get
        {
            if ((_serializerYaml == null))
            {
                _serializerYaml = new SerializerBuilder().ConfigureDefaultValuesHandling(DefaultValuesHandling.OmitDefaults | DefaultValuesHandling.OmitNull | DefaultValuesHandling.OmitEmptyCollections).Build();
            }
            return _serializerYaml;
        }
    }
    ...
    public virtual byte[] SerializeMsgPack()
    {
        ...
        try
        {
            ...
            MessagePackSerializer.Serialize(byteStream, this);
    ...
    {
        MemoryStream byteStream = null;
        return ((T)(MessagePackSerializer.Deserialize<T>(byteStream)));
        try
        {
    ...
    #region Serialize/Deserialize
    public virtual string SerializeYaml()
    {
        return SerializerYaml.Serialize(this);
    }
    ...
    /// <param name="exception">output Exception value if deserialize failed</param>
    /// <returns>true if this Serializer can deserialize the object; otherwise, false</returns>
    public static bool DeserializeYaml(string input, out T obj, out Exception exception)
    {
        exception = null;
        obj = default(T);
        try
        {
            obj = DeserializeYaml(input);
            return true;
        }
        catch (Exception ex)
        {
    ...
    public static bool DeserializeYaml(string input, out T obj)
    {
        Exception exception = null;
        return DeserializeYaml(input, out obj, out exception);
    }
    
    /// <summary>
    /// Deserializes Yaml to T object
    /// </summary>
    public new static T DeserializeYaml(string input)
    {
        IDeserializer deserializer = new DeserializerBuilder().Build();
        return ((T)(deserializer.Deserialize<T>(input)));
    }
    #endregion
    
    public virtual void SaveToFileYaml(string fileName)
    {
        StreamWriter streamWriter = null;
        try
        {
            string dataString = SerializeYaml();
            FileInfo outputFile = new FileInfo(fileName);
            streamWriter = outputFile.CreateText();
            streamWriter.WriteLine(dataString);
            streamWriter.Close();
    ...
    public new static T LoadFromFileYaml(string fileName)
    {
        FileStream file = null;
        StreamReader sr = null;
        try
        {
            ...
            sr.Close();
            file.Close();
            return DeserializeYaml(dataString);
        }
        finally
        {
            if ((file != null))
