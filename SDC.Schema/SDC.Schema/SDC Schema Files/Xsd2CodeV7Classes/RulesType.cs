...
/// --AutoActivation (RuleAutoActivateType)
/// --AutoSelection (RuleAutoSelectType)
/// --ConditionalActions (PredActionType)
/// --ExternalRule (CallFuncActionType)
/// --ScriptedRule (ScriptCodeAnyType)
...
public partial class RulesType : ExtensionBaseType
{
    ...
    [XmlElement("ExternalRule", typeof(CallFuncType), Order=0)]
