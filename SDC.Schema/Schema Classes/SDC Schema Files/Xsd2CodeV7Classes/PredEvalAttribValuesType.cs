...
public partial class PredEvalAttribValuesType : FuncBoolBaseType
{
    ...
    private bool _shouldSerializehasSelectionsExact;
    private bool _shouldSerializehasSelectionsLTE;
    private bool _shouldSerializehasSelectionsGTE;
    ...
    private System.Nullable<uint> _hasSelectionsGTE;
    private System.Nullable<uint> _hasSelectionsLTE;
    private System.Nullable<uint> _hasSelectionsExact;
    ...
    public virtual string itemNames
    {
        ...
        set
        {
                        ...
                        || (_itemNames.Equals(value) != true)))
            {
                ...
                validatorPropContext.MemberName = "itemNames";
    ...
    public virtual uint hasSelectionsGTE
    {
        get
        {
            if (_hasSelectionsGTE.HasValue)
            {
                return _hasSelectionsGTE.Value;
            }
            else
            {
                return default(uint);
    ...
    [XmlIgnore]
    public virtual bool hasSelectionsGTESpecified
    {
        get
        {
            return _hasSelectionsGTE.HasValue;
        }
        set
        {
            if (value==false)
            {
                _hasSelectionsGTE = null;
            }
        }
    }
    ...
    public virtual uint hasSelectionsLTE
    {
        get
        {
            if (_hasSelectionsLTE.HasValue)
            {
                return _hasSelectionsLTE.Value;
            }
            else
            {
                return default(uint);
    ...
    [XmlIgnore]
    public virtual bool hasSelectionsLTESpecified
    {
        get
        {
            return _hasSelectionsLTE.HasValue;
        }
        set
        {
            if (value==false)
            {
                _hasSelectionsLTE = null;
            }
        }
    }
    ...
    public virtual uint hasSelectionsExact
    {
        get
        {
            if (_hasSelectionsExact.HasValue)
            {
                return _hasSelectionsExact.Value;
            }
            else
            {
                return default(uint);
    ...
    [XmlIgnore]
    public virtual bool hasSelectionsExactSpecified
    {
        get
        {
            return _hasSelectionsExact.HasValue;
        }
        set
        {
            if (value==false)
            {
                _hasSelectionsExact = null;
            }
        }
    }
