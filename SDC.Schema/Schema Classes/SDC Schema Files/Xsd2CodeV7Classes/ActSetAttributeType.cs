...
public partial class ActSetAttributeType : ExtensionBaseType
{
    ...
    private System.Nullable<uint> _actMinCard;
    private System.Nullable<uint> _actMaxCard;
    ...
    public virtual string targetNames
    {
        ...
        set
        {
                        ...
                        || (_targetNames.Equals(value) != true)))
            {
                ...
                validatorPropContext.MemberName = "targetNames";
    ...
    public virtual uint actMinCard
    {
        get
        {
            if (_actMinCard.HasValue)
            {
                return _actMinCard.Value;
            }
            else
            {
                return default(uint);
    ...
    [XmlIgnore]
    public virtual bool actMinCardSpecified
    {
        get
        {
            return _actMinCard.HasValue;
        }
        set
        {
            if (value==false)
    ...
    public virtual uint actMaxCard
    {
        get
        {
            if (_actMaxCard.HasValue)
            {
                return _actMaxCard.Value;
            }
            else
            {
                return default(uint);
    ...
    [XmlIgnore]
    public virtual bool actMaxCardSpecified
    {
        get
        {
            return _actMaxCard.HasValue;
        }
        set
        {
            if (value==false)
