...
public partial class BasePackageType : ExtensionBaseType
{
    ...
    public virtual string lineage
    {
        ...
        set
        {
            ...
            {
                ValidationContext validatorPropContext = new ValidationContext(this, null, null);
                validatorPropContext.MemberName = "lineage";
                Validator.ValidateProperty(value, validatorPropContext);
                _lineage = value;
    ...
    public virtual string version
    {
        ...
        set
        {
            ...
            {
                ValidationContext validatorPropContext = new ValidationContext(this, null, null);
                validatorPropContext.MemberName = "version";
                Validator.ValidateProperty(value, validatorPropContext);
                _version = value;
    ...
    public virtual string fullURI
    {
        ...
        set
        {
            ...
            {
                ValidationContext validatorPropContext = new ValidationContext(this, null, null);
                validatorPropContext.MemberName = "fullURI";
                Validator.ValidateProperty(value, validatorPropContext);
                _fullURI = value;
    ...
    public bool AdminSpecified
    {
        get
        {
            return _adminSpecified;
        }
        set
        {
            _adminSpecified = value;
        }
    }
    ...
    public bool pkgTitleSpecified
    {
        get
        {
            return _pkgTitleSpecified;
        }
        set
        {
            _pkgTitleSpecified = value;
        }
    }
