...
namespace SDC.Schema
{
    ...
    /// </summary>
    /// <remarks>
    /// This shim was deprecated in the Phase 1 validation/datatype-builder refactor and remains only
    /// for source compatibility with older callers. New code should use
    /// <see cref="Extensions.IResponseFieldExtensions.AddDataType(ResponseFieldType, ItemChoiceType, dtQuantEnum, object?)"/>
    /// as the public entry point, or call <see cref="SdcDataTypeBuilder"/> directly for internal use.
    /// The shim will be removed in a future release after downstream callers have migrated.
    /// </remarks>
    [Obsolete("Deprecated since the Phase 1 refactor. Use rf.AddDataType() or SdcDataTypeBuilder instead.")]
