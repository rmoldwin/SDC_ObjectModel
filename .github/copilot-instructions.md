...
- **Recurring docs/issue hygiene (mandatory, minimal supervision expected):**
  ...
  4. A repo-agnostic version of this hygiene procedure is the personal skill `docs-issue-hygiene`, installed in `~/.copilot/skills/docs-issue-hygiene/` so it is available in every repository (source: [`skills/docs-issue-hygiene/SKILL.md` in rmoldwin/AI_Organize](https://github.com/rmoldwin/AI_Organize/blob/main/skills/docs-issue-hygiene/SKILL.md)). In this repo, the SDC-specific procedure above takes precedence over it.
