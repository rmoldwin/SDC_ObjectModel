	...
	public partial class float_DEtype : float_Stype
	{
		...
		public virtual byte fractionDigits
		{
			...
			set
			{
				...
				_shouldSerializefractionDigits = true;
			}
		}
		...
		protected internal bool _shouldSerializefractionDigits; //rm added 2022_09_22
		/// <summary>
		/// Test whether fractionDigits should be serialized
		/// </summary>
		public virtual bool ShouldSerializefractionDigits() //rm added 2022_09_22
		{
			if (_shouldSerializefractionDigits)
			{
				return true;
			}
