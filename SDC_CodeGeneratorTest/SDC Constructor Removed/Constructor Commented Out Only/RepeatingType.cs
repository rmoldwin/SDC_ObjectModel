...
public abstract partial class RepeatingType : DisplayedType
{
    ...
    protected internal bool _shouldSerializemaxCard;
    protected internal bool _shouldSerializeminCard;
    private uint _minCard;
    private uint _maxCard;
    ...
    public virtual bool ShouldSerializeminCard()
    {
        if (_shouldSerializeminCard)
        {
            ...
            return (_minCard != 1); // default(uint)); //rm changed 2022_09_21
		}
    ...
    public virtual bool ShouldSerializemaxCard()
    {
        if (_shouldSerializemaxCard)
        {
            ...
            return (_maxCard != 1); // default(uint)); //rm changed 2022_09_21
		}
